...
inverses.write('   owl:versionIRI        <http://www.w3.org/ns/prov-o-inverses-2012MMDD.owl>;\n')
inverses.write('   prov:wasRevisionOf    <http://www.w3.org/ns/prov-o-inverses-2012mmdd.owl>;\n')
inverses.write('   prov:specializationOf <http://www.w3.org/ns/prov-o-inverses.owl> .\n')
inverses.write('\n')
for property_uri in all_ordered['objectproperties']:
   property = session.get_resource(property_uri,ObjectProperties)
   qname = property.subject.split('#')
